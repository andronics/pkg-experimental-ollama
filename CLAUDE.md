# ollama - AI Assistant Instructions

**Package**: `@experimental/ollama`
**Version**: 0.1.0
**Type**: experimental package

## Package Overview

**Description**: Ollama Client - Local LLM management

**Purpose**: Provide ollama client - local llm management functionality for the pkgs ecosystem.
...
1. **Test installation**: `stow ollama`
2. **Test functionality**: Run main commands and verify output
3. **Test uninstallation**: `stow -D ollama`
